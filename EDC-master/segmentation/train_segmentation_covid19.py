# segmentation/train_segmentation_covid19.py
...
DATASET_PATH = "../COVID19_SEG"
BATCH_SIZE   = 8
EPOCHS       = 200
LR           = 3e-4
SEED         = 42
SAVE_DIR     = "./seg_checkpoints_covid19"
...
def run_experiment(use_hgbl, tag=''):
    ...
    full = COVID19SegDataset(DATASET_PATH)
    n    = len(full)
    nt   = max(1, int(0.8 * n))
    nv   = n - nt
    ...
    ckpt = os.path.join(SAVE_DIR,
           f"best_unet_covid19_{'hgbl' if use_hgbl else 'baseline'}.pth")
