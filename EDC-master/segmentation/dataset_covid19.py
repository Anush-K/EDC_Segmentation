...
# ===========================================================================
# AD_Dataset — used by edc_covid19.py for anomaly detection training
# ===========================================================================
class AD_Dataset(Dataset):
    ...
    def __init__(
        ...
        # --------------------------------------------------
            ...
            # TEST ABNORMAL (COVID, Lung_Opacity, Viral Pneumonia)
...
# ===========================================================================
# COVID19SegDataset — used by train_segmentation_covid19.py
# Returns (image_tensor, heatmap_tensor, mask_tensor)
#
# Expected folder layout under `root`:
#   images/    — COVID-1.png, Lung_Opacity-1.png, etc.
#   heatmaps/  — <basename>.png  (EDC anomaly maps)
#   masks/     — <basename>_mask.png  (GT lung masks)
# ===========================================================================
...
class COVID19SegDataset(Dataset):
    ...
    mask_tensor    : (1, 256, 256) float32 binary      — GT lung mask

    train_segmentation_covid19.py concatenates image + heatmap → (4, 256, 256)
    ...
    def __getitem__(self, idx):
        name = self.files[idx]
        base = os.path.splitext(name)[0]   # e.g. "COVID-1"
