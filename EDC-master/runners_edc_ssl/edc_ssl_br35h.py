# runners_edc_ssl/edc_ssl_br35h.py
"""
...
Identical to runners_edc/edc_aptos.py EXCEPT:
  ...
  - save_name defaults to 'edc_ssl_br35h'
"""
...
def main_worker(gpu, args):
    ...
    print("\n===== FINAL EVALUATION METRICS – SSL-EDC Br35H =====")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='SSL-EDC Br35H')

    # Saving
    parser.add_argument('--save_dir',  type=str, default='./saved_models')
    parser.add_argument('--save_name', type=str, default='edc_ssl_br35h')
