# runners_edc_ssl/edc_ssl_lungct.py
"""
...
Identical to runners_edc/edc_aptos.py EXCEPT:
  ...
  - save_name defaults to 'edc_ssl_lungct'
"""
...
import warnings
from configs.config_lungct import DATASET_DIR
...
def main_worker(gpu, args):
    ...
    print("\n===== FINAL EVALUATION METRICS – SSL-EDC LungCT =====")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='SSL-EDC LungCT')

    # Saving
    parser.add_argument('--save_dir',  type=str, default='./saved_models')
    parser.add_argument('--save_name', type=str, default='edc_ssl_lungct')
    ...
    parser.add_argument('--dataset',       type=str, default='lungct')
