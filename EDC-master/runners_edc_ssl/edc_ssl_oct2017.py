# runners_edc_ssl/edc_ssl_oct2017.py
"""
...
Identical to runners_edc/edc_aptos.py EXCEPT:
  ...
  - save_name defaults to 'edc_ssl_oct2017'
"""
...
def main_worker(gpu, args):
    ...
    print("\n===== FINAL EVALUATION METRICS – SSL-EDC OCT2017 =====")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='SSL-EDC OCT2017')

    # Saving
    parser.add_argument('--save_dir',  type=str, default='./saved_models')
    parser.add_argument('--save_name', type=str, default='edc_ssl_oct2017')
    ...
    parser.add_argument('--dataset',       type=str, default='oct2017')
