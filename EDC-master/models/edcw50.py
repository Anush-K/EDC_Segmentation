# models/edcw50.py
#
# BACKBONE ABLATION VARIANT: Wide ResNet-50-2 encoder + decoder
# -------------------------------------------------------------------------
# Standalone file — does NOT modify models/edc.py.
# This architecture already existed as WR50_WR50 inside models/edc.py;
# extracted here as its own file so runner scripts can import it cleanly
# without ambiguity, matching edc34.py / edc32.py.
#
# CHANNEL NOTE:
# WideResNet50-2 uses Bottleneck (expansion=4), so layer4 output is 2048
# channels — identical to ResNet50 and ResNeXt50. Safe drop-in with
# inplanes=[2048].

from models.resnet import wide_resnet50_2
from models.resnet_decoder import wide_resnet50_decoder
...
class WR50_WR50(nn.Module):
    """
    Wide ResNet-50-2 encoder + Wide ResNet-50-2 decoder for EDC anomaly detection.
