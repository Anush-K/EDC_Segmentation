...
# BACKBONE ABLATION: ResNet-34 encoder/decoder, Br35H dataset
...
from models.edc34 import R34_R34          # backbone ablation — untouched edc34.py
...
def main_worker(gpu, args):
    ...
    print("\n======== FINAL EVALUATION METRICS — Br35H / ResNet34 (5-seed ensemble) ========\n")
    ...
    mis_dir = os.path.join(save_path, "misclassified_br35h34")
    ...
    pd.DataFrame(results,
        ...
        os.path.join(save_path, "results_test_edc_br35h34.csv"), index=False)
    pd.DataFrame(misclassified,
        columns=["S.No","Filename","GT","Pred","Score"]).to_csv(
        os.path.join(save_path, "misclassified_test_edc_br35h34.csv"), index=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-sn', '--save_name', type=str,      default='edc_br35h34')
