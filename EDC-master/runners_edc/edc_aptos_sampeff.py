# runners_edc/edc_aptos_sampeff.py
#
# SECTION F: Sample-Efficiency Analysis (APTOS)
# Standalone file — does NOT modify edc_aptos.py or methods/edc1.py.
...
#   python runners_edc/edc_aptos_sampeff.py --num_train_samples 100  --save_name edc_aptos_n100
#   python runners_edc/edc_aptos_sampeff.py --num_train_samples 200  --save_name edc_aptos_n200
#   python runners_edc/edc_aptos_sampeff.py --num_train_samples 500  --save_name edc_aptos_n500
#   python runners_edc/edc_aptos_sampeff.py --num_train_samples 1000 --save_name edc_aptos_n1000
#   python runners_edc/edc_aptos_sampeff.py --num_train_samples 2000 --save_name edc_aptos_n2000
#   # full-dataset point: reuse your existing confirmed Table 1 result (96.85% AUC) — no re-run needed
...
def main_worker(args):
    ...
    print("\n======== SAMPLE-EFFICIENCY RESULT — APTOS ========")
    ...
    results_csv = os.path.join(args.save_dir, "sample_efficiency_aptos_results.csv")
...
if __name__ == "__main__":
    ...
    parser.add_argument('-sn', '--save_name',   type=str,      default='edc_aptos_sampeff')
