# runners_edc/edc_kvasir.py
# NOVELTY 1: RQASW — Residual Quality-Aware Scale Weighting
#
# No official base paper exists for Kvasir in the EDC paper. This runner
...
#     unified with COVID-19/BUSI/LGG (previously 5 epochs here).
...
def run_single_seed(gpu, args, seed):
    ...
    if seed == 0:
        ...
        # target used across COVID-19/BUSI/LGG (previously 5 epochs
        # specifically for Kvasir).
    ...
    # amap_reduction='mean' kept as previously used for Kvasir
    runner = EDC(
...
def main_worker(gpu, args):
    ...
    print("\n======== FINAL EVALUATION METRICS — KVASIR (5-seed ensemble) ========\n")
