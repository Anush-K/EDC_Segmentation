...
# BACKBONE ABLATION: ResNeXt-50 32x4d encoder/decoder, APTOS dataset
...
from models.edc32 import RX50_RX50
...
def main_worker(gpu, args):
    ...
    print("\n======== FINAL EVALUATION METRICS — APTOS / ResNeXt50-32x4d (5-seed best) ========\n")
    ...
    mis_dir = os.path.join(save_path, "misclassified_aptos32")
    ...
    pd.DataFrame(results,
        ...
        os.path.join(save_path, "results_test_edc_aptos32.csv"), index=False)
    pd.DataFrame(misclassified,
        columns=["S.No","Filename","GT","Pred","Score"]).to_csv(
        os.path.join(save_path, "misclassified_test_edc_aptos32.csv"), index=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-sn', '--save_name',   type=str,      default='edc_aptos32')
